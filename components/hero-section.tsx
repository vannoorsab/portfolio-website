...
export function HeroSection() {
  ...
  return (
    <section id="home" className="py-12 lg:py-24 relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Scanlines */}
      ...
      <div className="container mx-auto px-4 pt-24 pb-12 lg:py-20 relative z-10">
